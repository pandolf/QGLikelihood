...
class QGLikelihoodCalculator {
 ...
 public:
  ...
  QGLikelihoodCalculator( const std::string& fileName="/afs/cern.ch/work/p/pandolf/public/ReducedHisto_2012.root", unsigned nPtBins=21, unsigned int nRhoBins=45 );
